...
불변 (invariants): 컴퓨터 off OK · 1 프로젝트 = 1 리포 = 1 루틴 · 완료 시 루틴 자동 비활성 · 모바일 푸시
...
Spec-seed pattern + Stage 2 intent check inspired by [Q00/ouroboros](https://github.com/Q00/ouroboros) (MIT) — concepts only, no code copied.
